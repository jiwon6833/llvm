...
#define DEBUG_TYPE "aarch64-mpt-memory_isolation_pass"
...
namespace llvm {
    void initializeAArch64MemoryIsolationPass(PassRegistry &);
}

#define AARCH64_MPTPASS_NAME "AArch64 Memory Isolation Pass"

namespace {
    struct AArch64MemoryIsolation : public MachineFunctionPass {
        static char ID;
        AArch64MemoryIsolation() : MachineFunctionPass(ID) {
            initializeAArch64MemoryIsolationPass(*PassRegistry::getPassRegistry());
        }
        ...
        StringRef getPassName() const override {
            return AARCH64_MPTPASS_NAME;
        }
    };
    char AArch64MemoryIsolation::ID = 0;
}

INITIALIZE_PASS(AArch64MemoryIsolation, "aarch64-mpt-memory_isolation_pass", AARCH64_MPTPASS_NAME, false, false)

FunctionPass *llvm::createAArch64MemoryIsolationPass() {
    dbgs() << "AArch64MemoryIsolationPass\n";
    return new AArch64MemoryIsolation();
}
...
bool AArch64MemoryIsolation::runOnMachineFunction(MachineFunction &Fn) {
